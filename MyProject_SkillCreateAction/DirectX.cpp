...
@param[in]	| fullscreen：フルスクリーンモードにするかどうか
@return		| HRESULT
*//*************************/
...
/*************************//*
@brief		| レンダーターゲット、デプスステンシルの設定
@param[in]	| num：レンダーターゲットの数
@param[in]	| ppViews：レンダーターゲットの配列
@param[in]	| pView：デプスステンシル
*//*************************/
...
/*************************//*
@brief		| 深度テストの設定
@param[in]	| enable：深度テストを有効にするかどうか
*//*************************/
